...
model_args = dict(
    version="qwen2",
    pretrain_mm_mlp_adapter="./logdir/emova-qwen2_5-0.5b-qwen2vit600m-pretrain/mm_projector.bin",

    language_model=dict(trainable=True, attn_implementation="flash_attention_2",
                        pretrained_model_name_or_path='Emova-ollm/Qwen2.5-0.5B-Instruct_add_speech_token_4096_nostrip/',
                        ),
...
training_args = dict(
    output_dir="./logdir/emova-qwen2_5-0.5b-qwen2vit600m-alignment/",
